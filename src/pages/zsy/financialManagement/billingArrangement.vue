 ...
 <div class="billingArrangement">
   ...
   <div class="allWrapper">
       ...
       <div class="searchBox">
         <div class="element">
           ...
           <div class="width100 inline">
             <el-input size="medium" clearable placeholder="" class="input" v-model="searchs.shopName" @keyup.enter.native="searchData"></el-input>
           </div>
         </div>
         <div class="element">
           <p class="inline">商户:</p>
           <div class="width140 inline">
             <el-input size="medium" clearable placeholder="" class="input" v-model="searchs.merchantName" @keyup.enter.native="searchData"></el-input>
           </div>
         </div>
         <div class="element">
       ...
       <transition name="">
         <div class="searchBox clear" v-if="searchCell">
           <div class="element">
             ...
             <div class="width140 inline">
               <el-input size="medium" clearable placeholder="" class="input" v-model="searchs.merchantOrderNo" @keyup.enter.native="searchData"></el-input>
             </div>
           </div>
           <div class="element">
             <p class="inline">代理商:</p>
             <div class="width140 inline">
               <el-input size="medium" clearable placeholder="" class="input"  v-model="searchs.agentName" @keyup.enter.native="searchData"></el-input>
             </div>
           </div>
           <div class="element">
             <p class="inline">服务密码:</p>
             <div class="width140 inline">
               <el-input size="medium" clearable placeholder="" class="input" v-model="searchs.agentServiceCode" @keyup.enter.native="searchData"></el-input>
             </div>
           </div>
         </div>
       </transition>
     ...
     <div class="tableWrapper">
       <div class="tableWrapper-excel"><span class="tableWrapper-excel-pad">实收金额:{{money}}</span><span class="tableWrapper-excel-border" @click="downloadExl()" style="cursor: pointer;">导出成excel</span></div>
       <el-table :data="tableData" stripe>
         ...
         <el-table-column label="收款方式" width="170">
           <template slot-scope="scope">
             {{scope.row.paymode | collectionType}}
           </template>
         </el-table-column>
         <el-table-column prop="merchantOrderNo" label="订单号" width="220"></el-table-column>
