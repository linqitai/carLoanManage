  ...
  <div class="channelReconciliation">
    ...
    <div class="allWrapper">
      <div class="searchCondition">
        <div class="searchBox">
          <div class="element">
            ...
            <div class="inline">
              <el-date-picker size="medium" class="inline" style="width:134px;" type="date" placeholder="开始时间"
                              @change="startTimeChange">
              </el-date-picker>
              <span class="inline">至</span>
              <el-date-picker size="medium" class="inline" style="width:134px;" type="date" placeholder="结束时间"
      ...
      <div class="tableWrapper">
        <div class="tableWrapper-excel"><span>支付交易:，</span>
          <span>退款交易:，</span>
          <span>手续费:，</span>
          <span class="tableWrapper-excel-pad">清算金额:元</span>
          <span class="tableWrapper-excel-border" @click="downloadExl()">导出成excel</span>
        </div>
...
<script>
  import { tableData } from 'common/js/config'
  export default {
    data() {
      return {
        searchCell: false,
...
<style scoped lang="scss">
  ...
  @import './channelReconciliation.scss'
</style>
