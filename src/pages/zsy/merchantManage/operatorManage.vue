    ...
    <div class="allWrapper">
      <div class="searchCondition">
        <div class="searchBox">
          ...
          <div class="element">
            ...
            <div class="width140 inline">
              <el-input size="medium" clearable placeholder="所在店铺查询" class="input" v-model="searchs.store" @keyup.enter.native="search"></el-input>
            </div>
          </div>
          <div class="element">
      ...
      <div class="tableWrapper">
        <el-table :data="tableData" stripe style="width: 1270px;">
          ...
          <el-table-column label="所属商户" width="200">
            <template slot-scope="scope">
              <el-button type="text" size="small">{{scope.row.merchant}}</el-button>
            </template>
          </el-table-column>
        </el-table>
...
import { sexList, roleList, operatorData } from 'common/js/config'
export default {
  data() {
    return {
      maxLengthMobile: 11,
