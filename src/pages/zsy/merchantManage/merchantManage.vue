      ...
      <div class="allWrapper">
        <div class="searchCondition">
          <div class="element">
            <p class="inline">时间</p>
            <div class="inline">
              <el-date-picker size="medium" class="inline" style="width:134px;" v-model="searchs.startTime" type="date"
                              placeholder="开始时间" value-format="yyyy-MM-dd" @change="startTimeChange">
              </el-date-picker>
              <span class="inline">至</span>
              <el-date-picker size="medium" class="inline" value-format="yyyy-MM-dd" style="width:134px;"
                              v-model="searchs.endTime" type="date"
                              placeholder="结束时间" @change="endTimeChange">
              </el-date-picker>
            </div>
          </div>
          <div class="element">
            ...
            <div class="width140 inline">
              <el-input size="medium" clearable placeholder="商户名称查询" class="input" v-model="searchs.mName"
          ...
          <div class="element">
            ...
            <div class="width120 inline">
              <el-input size="medium" clearable v-model="searchs.fzMan" placeholder="负责人查询" class="input"
                        @keyup.enter.native="search"></el-input>
            </div>
          </div>
          <div class="element">
            ...
            <div class="width130 inline">
              <el-input size="medium" clearable v-model="searchs.mobile" placeholder="手机号码查询"
                        :maxlength="maxLengthMobile" class="input" @keyup.enter.native="search"></el-input>
            </div>
          </div>
          <div class="element">
            <p class="inline">状态</p>
          ...
          <div class="element">
            ...
            <div class="width120 inline">
              <el-input size="medium" clearable v-model="searchs.agent" placeholder="代理商查询" class="input"
                        @keyup.enter.native="search"></el-input>
            </div>
          </div>
          <div class="element">
        ...
        <div class="tableWrapper">
          <el-table :data="tableData" stripe>
            <el-table-column fixed="left" prop="applyTime" label="申请时间" width="170"></el-table-column>
            <el-table-column prop="merchantname" label="商户名称" show-overflow-tooltip></el-table-column>
            <el-table-column prop="merchanttype" label="商户类型" :formatter="shopType"></el-table-column>
            <el-table-column prop="operatetype" label="经营类目" :formatter="manageType"></el-table-column>
            ...
            <el-table-column prop="isaudit" label="状态" :formatter="stateType"></el-table-column>
            <el-table-column prop="agentName" label="代理商"></el-table-column>
            <el-table-column label="操作" width="170" fixed="right">
              <template slot-scope="scope">
                <el-button type="text" size="small" v-if="scope.row.isaudit !== 2 && scope.row.isaudit !== 6"
                           @click="detail(scope.row, false)">详情
                </el-button>
                <el-button type="text" size="small" v-if="scope.row.isaudit === 2 || scope.row.isaudit === 6"
                           @click="detail(scope.row, true)">审核
                </el-button>
                <el-button type="text" size="small" v-if="scope.row.isaudit == 5 || scope.row.isaudit == 8"
                           @click="openOrClose(scope.row)">
                  {{scope.row.isaudit | openClose}}
                </el-button>
                <el-button type="text" size="small" v-if="scope.row.isaudit == 5 || scope.row.isaudit == 8"
                           @click="toStoreManage(scope.row)">门店
                </el-button>
              </template>
            </el-table-column>
          </el-table>
        ...
        <div class="tableBottom">
          <el-pagination class="pagination" @size-change="handleSizeChange" @current-change="handleCurrentChange"
                         :current-page.sync="searchs.pageIndex" :page-size="searchs.pageSize"
