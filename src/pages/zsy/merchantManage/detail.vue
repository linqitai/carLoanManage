    ...
    <el-checkbox-group v-model="checks" @change="checksEvent">
      <div class="allWrapper">
          ...
          <div class="contentText">
            <div class="lineText">
              ...
              <div class="inforeditor" v-if="infor.isaudit === 2 || infor.isaudit === 6">
                ...
                <input type="text" v-if="newObj.merchantname.check" v-model="newObj.merchantname.errorText"
                       class="audit fl" placeholder="最多输入15个字" maxlength="15">
              </div>
            </div>
            <div class="lineText" v-if="infor.isaudit !== 1 && infor.isaudit !== 4 && infor.isaudit !== 7">
              ...
              <div class="inforeditor" v-if="infor.isaudit === 2 || infor.isaudit === 6">
                ...
                <input type="text" v-if="newObj.abbreviation.check" v-model="newObj.abbreviation.errorText"
                       class="audit fl" placeholder="最多输入15个字" maxlength="15">
              </div>
              <i v-if="status===statusNormal && infor.isaudit === 5" class="iconfont icon-bianji-copy ml10 fontSizeM"
                 @click="showEditStoreName=true"></i>
              <el-dialog title="编辑商户简称" :visible.sync="showEditStoreName">
                <div class="element">
                  <p class="width100 textLeft inline">商户简称</p>
                  <div class="inline">
                    <el-input size="medium" clearable placeholder="请输入商户简称" class="input"
            ...
            <div class="lineText">
              ...
              <div class="inforeditor" v-if="infor.isaudit === 2 || infor.isaudit === 6">
                ...
                <input type="text" v-if="newObj.merchanttype.check" v-model="newObj.merchanttype.errorText"
                       class="audit fl" placeholder="最多输入15个字" maxlength="15">
              </div>
            </div>
            <div class="lineText" v-if="infor.isaudit !== 1 && infor.isaudit !== 4 && infor.isaudit !== 7">
              <span class="label">商户号</span>
              <span class="value">{{infor.merchantid}}</span>
              <div class="inforeditor" v-if="infor.isaudit === 2 || infor.isaudit === 6">
                <el-checkbox :label="Object.assign(newObj.merchantid, {'journeys': 1,'errorFlags': 1})" class="fl">未通过
                </el-checkbox>
                <input type="text" v-if="newObj.merchantid.check" v-model="newObj.merchantid.errorText" class="audit fl"
            ...
            <div class="lineText" v-if="infor.isaudit !== 1 && infor.isaudit !== 4 && infor.isaudit !== 7">
              ...
              <div class="inforeditor" v-if="infor.isaudit === 2 || infor.isaudit === 6">
                ...
                <input type="text" v-if="newObj.userid.check" v-model="newObj.userid.errorText" class="audit fl"
                       placeholder="最多输入15个字">
              </div>
            </div>
            <div class="lineText" v-if="infor.merchanttype !== 2">
              ...
              <div class="inforeditor" v-if="infor.isaudit === 2 || infor.isaudit === 6">
                ...
                <input type="text" v-if="newObj.businessnumber.check" v-model="newObj.businessnumber.errorText"
                       class="audit fl" placeholder="最多输入15个字">
              </div>
            </div>
            <div class="lineText">
              ...
              <i v-if="status===statusNormal && infor.isaudit === 5" class="iconfont icon-bianji-copy ml10 fontSizeM"
                 @click="showEditServicePhone=true"></i>
              <el-dialog width="40%" style="z-index:3000" title="编辑商客服电话" :visible.sync="showEditServicePhone">
                <div class="element">
                  ...
                  <div class="inline">
                    <el-input size="medium" clearable placeholder="请输入客服电话" class="input"
                              v-model="servicephone"></el-input>
                  </div>
                </div>
                <div slot="footer" class="dialog-footer">
              ...
              <div class="inforeditor" v-if="infor.isaudit === 2 || infor.isaudit === 6">
                ...
                <input type="text" v-if="newObj.servicephone.check" v-model="newObj.servicephone.errorText"
                       class="audit fl" placeholder="最多输入15个字" maxlength="15">
              </div>
            </div>
            <div class="lineText">
              ...
              <i v-if="status===statusNormal && infor.isaudit === 5" class="iconfont icon-bianji-copy ml10 fontSizeM"
                 @click="showEditManageType=true"></i>
                ...
                <div class="element">
                  ...
                  <div class="width140 inline">
                    <el-select size="medium" placeholder="请选择" v-model="operatetype">
                      <el-option v-for="item in manageTypeList" :key="item.value" :label="item.label"
                                 :value="item.value">
                      </el-option>
                    </el-select>
                  </div>
              ...
              <div class="inforeditor" v-if="infor.isaudit === 2 || infor.isaudit === 6">
                ...
                <input type="text" v-if="newObj.operatetype.check" v-model="newObj.operatetype.errorText"
                       class="audit fl" placeholder="最多输入15个字" maxlength="15">
              </div>
            </div>
            <div class="lineText">
              ...
              <i v-if="status===statusNormal && infor.isaudit === 5" class="iconfont icon-bianji-copy ml10 fontSizeM"
                 @click="showEditManageClass=true"></i>
              ...
              <div class="inforeditor" v-if="infor.isaudit === 2 || infor.isaudit === 6">
                ...
                <input type="text" v-if="newObj.operatecategory.check" v-model="newObj.operatecategory.errorText"
                       class="audit fl" placeholder="最多输入15个字" maxlength="15">
              </div>
            </div>
            <div class="lineText">
              ...
              <i v-if="status===statusNormal && infor.isaudit === 5" class="iconfont icon-bianji-copy ml10 fontSizeM"
                 @click="showEditStoreAddress=true"></i>
          ...
          <div class="contentText">
            <div class="lineText">
              ...
              <div class="inforeditor" v-if="infor.isaudit === 2 || infor.isaudit === 6">
                ...
                <input type="text" v-if="newObj.responsiblename.check" v-model="newObj.responsiblename.errorText"
                       class="audit fl" placeholder="最多输入15个字" maxlength="15">
              </div>
            </div>
            <div class="lineText"
                 v-if="infor.isaudit !== 1 && infor.merchanttype !==3 && infor.isaudit !== 4 && infor.isaudit !== 7">
              <span class="label">手机号码</span>
              <span class="value">{{infor.phone}}</span>
              <i v-if="status===statusNormal && infor.isaudit === 5" class="iconfont icon-bianji-copy ml10 fontSizeM"
                 @click="showEditMobile=true"></i>
              <div class="inforeditor" v-if="infor.isaudit === 2 || infor.isaudit === 6">
                <el-checkbox :label="Object.assign(newObj.phone, {'journeys': 2,'errorFlags': 1})" class="fl">未通过
                </el-checkbox>
                <input type="text" v-if="newObj.phone.check" v-model="newObj.phone.errorText" class="audit fl"
                       placeholder="最多输入15个字" maxlength="15">
              </div>
            </div>
            <div class="lineText">
            ...
            <img class="preview-img" v-for="(item, index) in list" :src="item.src" :key="item.src" height="100"
                 @click="$preview.open(0, list)" v-show="false">
            <div class="lineText">
              <span class="label">身份证正面</span>
              <span class="value" @click="previewImg(0)">
              <img :src="newObj.images2.path" ref="img0" class="img">
            </span>
              <i v-if="status===statusNormal && infor.isaudit === 5"
                 class="iconfont icon-bianji-copy ml10 fontSizeM editImg" @click="openImgdialog({type: 2})">
                <!--图片编辑dialog-->
              </i>
              <div class="inforeditor" v-if="infor.isaudit === 2 || infor.isaudit === 6">
                <el-checkbox :label="Object.assign(newObj.images2, {'journeys': 2,'errorFlags': 0})" class="fl">未通过
                </el-checkbox>
                <input type="text" v-if="newObj.images2.check" v-model="newObj.images2.errorText" class="audit fl"
                       placeholder="最多输入15个字" maxlength="15">
              </div>
            </div>
            <el-dialog
            ...
            <div class="lineText">
              ...
              <img :src="newObj.images3.path" ref="img1" class="img">
            </span>
              <i v-if="status===statusNormal && infor.isaudit === 5"
                 class="iconfont icon-bianji-copy ml10 fontSizeM editImg" @click="openImgdialog({type: 3})"></i>
              <div class="inforeditor" v-if="infor.isaudit === 2 || infor.isaudit === 6">
                <el-checkbox :label="Object.assign(newObj.images3, {'journeys': 2,'errorFlags': 0})" class="fl">未通过
                </el-checkbox>
                <input type="text" v-if="newObj.images3.check" v-model="newObj.images3.errorText" class="audit fl"
                       placeholder="最多输入15个字" maxlength="15">
              </div>
            </div>
          </div>
        ...
        <div class="infoBox imggroup" id="picInfo">
          ...
          <div class="contentText">
            <img class="preview-img" v-for="(item, index) in listPicData" :src="item.src" :key="item.src" height="100"
                 @click="$preview.open(0, listPicData)" v-show="false">
            <div class="lineText" v-if="infor.merchanttype !== 2">
              <span class="label">营业执照</span>
              <span class="value" @click="previewImgPicData(0)">
              <img :src="newObj.images1.path" ref="imgPicData0" class="img">
            </span>
              <i v-if="status===statusNormal && infor.isaudit === 5"
                 class="iconfont icon-bianji-copy ml10 fontSizeM editImg" @click="openImgdialog({type: 1})"></i>
              <div class="inforeditor" v-if="infor.isaudit === 2 || infor.isaudit === 6">
                <el-checkbox :label="Object.assign(newObj.images1, {'journeys': 3,'errorFlags': 0})" class="fl">未通过
                </el-checkbox>
                <input type="text" v-if="newObj.images1.check" v-model="newObj.images1.errorText" class="audit fl"
                       placeholder="最多输入15个字" maxlength="15">
              </div>
            </div>
            <div class="lineText">
              ...
              <img :src="newObj.images4.path" ref="imgPicData1" class="img">
            </span>
              <i v-if="status===statusNormal && infor.isaudit === 5"
                 class="iconfont icon-bianji-copy ml10 fontSizeM editImg" @click="openImgdialog({type: 4})"></i>
              <div class="inforeditor" v-if="infor.isaudit === 2 || infor.isaudit === 6">
                <el-checkbox :label="Object.assign(newObj.images4, {'journeys': 3,'errorFlags': 0})" class="fl">未通过
                </el-checkbox>
                <input type="text" v-if="newObj.images4.check" v-model="newObj.images4.errorText" class="audit fl"
                       placeholder="最多输入15个字" maxlength="15">
              </div>
            </div>
            <div class="lineText" v-if="infor.merchanttype === 3">
              ...
              <img :src="newObj.images6.path" ref="imgPicData2" class="img">
            </span>
              <i v-if="status===statusNormal && infor.isaudit === 5"
                 class="iconfont icon-bianji-copy ml10 fontSizeM editImg" @click="openImgdialog({type: 6})"></i>
              <div class="inforeditor" v-if="infor.isaudit === 2 || infor.isaudit === 6">
                <el-checkbox :label="Object.assign(newObj.images6, {'journeys': 3,'errorFlags': 0})" class="fl">未通过
                </el-checkbox>
                <input type="text" v-if="newObj.images6.check" v-model="newObj.images6.errorText" class="audit fl"
                       placeholder="最多输入15个字" maxlength="15">
              </div>
            </div>
          </div>
        ...
        <div class="infoBox">
          <div class="title">
            提现银行卡
            <i v-if="status===statusNormal && infor.isaudit === 5"
               class="iconfont icon-bianji-copy ml10 fontSizeM colorGray"
               @click="editBankCard"></i>
          </div>
          ...
          <el-dialog title="编辑提现银行卡" :visible.sync="showEditBankEdit" width="40%">
            <div class="dialogContent">
              ...
              <div class="element" v-if="infor.accounttype == 1">
                ...
                <div class="width200 inline">
                  <el-select
                    ...
                    reserve-keyword
                    placeholder="请输入银行卡号"
                    :remote-method="subBankClick"
                    :loading="loading">
                    <el-option
                      v-for="item in bankSearchList"
                      :key="item.subBankid"
                      :label="item.bankname"
                      :value="item.subBankid">
                    </el-option>
                  </el-select>
                </div>
              </div>
              <div class="element" v-if="infor.accounttype == 2">
                ...
                <div class="width200 inline">
                  <el-input size="medium" clearable placeholder="请输入银行卡号" v-model="newbanknumbe"
          ...
          <div class="contentText">
            <div class="lineText" v-if="infor.isaudit !== 5 && infor.isaudit !== 8">
              ...
              <div class="inforeditor" v-if="infor.isaudit === 2 || infor.isaudit === 6">
                ...
                <input type="text" v-if="newObj.clearmode.check" v-model="newObj.clearmode.errorText" class="audit fl"
                       placeholder="最多输入15个字" maxlength="15">
              </div>
            </div>
            <div class="lineText">
              ...
              <div class="inforeditor" v-if="infor.isaudit === 2 || infor.isaudit === 6">
                ...
                <input type="text" v-if="newObj.accounttype.check" v-model="newObj.accounttype.errorText"
                       class="audit fl" placeholder="最多输入15个字" maxlength="15">
              </div>
            </div>
            <div class="lineText" v-if="infor.merchanttype === 3">
              ...
              <div class="inforeditor" v-if="infor.isaudit === 2 || infor.isaudit === 6">
                ...
                <input type="text" v-if="newObj.openaccount.check" v-model="newObj.openaccount.errorText"
                       class="audit fl" placeholder="最多输入15个字" maxlength="15">
              </div>
            </div>
            <div class="lineText" v-if="infor.merchanttype !== 3">
              ...
              <div class="inforeditor" v-if="infor.isaudit === 2 || infor.isaudit === 6">
                ...
                <input type="text" v-model="newObj.openaccount.errorText" v-if="newObj.openaccount.check"
                       class="audit fl" placeholder="最多输入15个字" maxlength="15">
              </div>
            </div>
            <div class="lineText" v-if="infor.merchanttype === 3">
            ...
            <div class="lineText">
              ...
              <div class="inforeditor" v-if="infor.isaudit === 2 || infor.isaudit === 6">
                ...
                <input type="text" v-if="newObj.bank.check" v-model="newObj.bank.errorText" class="audit fl"
                       placeholder="最多输入15个字" maxlength="15">
              </div>
            </div>
            <div class="lineText" v-if="infor.merchanttype !== 3">
              ...
              <div class="inforeditor" v-if="infor.isaudit === 2 || infor.isaudit === 6">
                ...
                <input type="text" v-if="newObj.banknumbe.check" v-model="newObj.banknumbe.errorText" class="audit fl"
                       placeholder="最多输入15个字" maxlength="15">
              </div>
            </div>
            <div class="lineText" v-if="infor.merchanttype !== 3">
        ...
        <div class="infoBox"
             v-if="infor.isaudit !== 1 && infor.isaudit !== 4 && infor.isaudit !== 7 && infor.isaudit !== 2 && infor.isaudit !== 6">
          <div class="title">清算信息</div>
          <div class="contentText">
            <div class="lineText">
              <span class="label">结算方式</span>
              <span class="value">{{infor.clearmode | clearmodeState}}</span>
              <i v-if="status===statusNormal && infor.isaudit === 5 && infor.yulibaoState === 2"
                 class="iconfont icon-bianji-copy ml10 fontSizeM" @click="showEditMoneyEvent=true"></i>
            </div>
            <el-dialog width="650px" title="编辑费率" :visible.sync="showEditMoneyEvent">
              <div class="contentTextForRow">
                ...
                <div class="lineText">
                  ...
                  <span class="value">
                    <el-checkbox class="fl" @change="T0Click" :checked="clearmode"
                                 :disabled="!clearmode">支持</el-checkbox>
                  </span>
                </div>
                <div class="lineText">
              ...
              <span v-if="isDisabledHB2">
                ...
                &#x3000;&#x3000;
                <span class="t1money" v-if="isDisabledHB4">T+0费率&#x3000;<input class="moneyInput" type="text"
                                                                               placeholder="0.38"
              ...
              <span v-if="isDisabledHB3">
                <span class="t0money">T+1费率&#x3000;<input class="moneyInput" type="text" placeholder="0.38"
                                                          v-model="wechatratesT1"> %</span>
              &#x3000;&#x3000;<span class="t1money" v-if="isDisabledHB4">T+0费率&#x3000;<input class="moneyInput"
                                                                                             type="text"
                                                                                             placeholder="0.38"
            ...
            <div class="lineText">
              ...
              <!--infor.paychannels-->
              <span class="value">
                <div v-if="infor.paychannels==='01' || infor.paychannels==='01,02'"><span
                  class="width80 left">支付宝</span>T+1费率：{{infor.signup.aliratesT1}}&#x3000;T+0费率：{{infor.signup.aliratesT0}}</div>
                <br/>
                <div v-if="infor.paychannels==='02' || infor.paychannels==='01,02'"><span
                  class="width80 left">微信支付</span>T+1费率：{{infor.signup.wechatratesT1}}&#x3000;T+0费率：{{infor.signup.wechatratesT0}}</div>
              </span>
            </div>
            <div class="lineText">
              ...
              <i v-if="status===statusNormal && infor.isaudit === 5" class="iconfont icon-bianji-copy ml10 fontSizeM"
                 @click="showEditDealTypeEvent=true"></i>
                ...
                <div class="contentTextForRow">
                  ...
                  <div class="contentTextR">
                    <el-checkbox-group v-model="tradetypes">
                      <div v-for="(value, key) in payType">
            ...
            <div class="lineText">
              ...
              <i v-if="status===statusNormal && infor.isaudit === 5" class="iconfont icon-bianji-copy ml10 fontSizeM"
                 @click="showEditForbiddenMethodEvent=true"></i>
              <el-dialog style="editDialog" width="500px" title="编辑禁用支付方式" :visible.sync="showEditForbiddenMethodEvent">
                <div>
                  ...
                  <el-checkbox-group v-model="deniedpays">
                    <span><el-checkbox label="03" key="1" @change="change1">禁用花呗（支付宝）</el-checkbox></span>
                    <span><el-checkbox label="02" key="2">禁用信用卡（微信支付刷卡支付（被扫）模式无法禁用信用卡支付）</el-checkbox></span>
                  </el-checkbox-group>
                  <br>
                </div>
        ...
        <div class="infoBox" v-if="infor.isaudit !== 1">
          ...
          <div class="contentText">
            ...
            <div class="lineText"
                 v-if="infor.isaudit !== 1 && infor.merchanttype !==3 && infor.isaudit !== 4 && infor.isaudit !== 7 && infor.isaudit !== 2 && infor.isaudit !== 6">
        ...
        <div class="infoBox mb20">
          ...
          <div class="contentText mtb10">
            ...
            <el-button size="medium" class="btn mt10" @click="intoCheck"
                       v-if="(checks.length === 0 && type) ? true : false">下一步
            </el-button>
            <el-button size="medium" class="btn mt10" @click="centerDialogVisible = true"
                       v-if="checks.length !== 0 ? true : false">审核驳回
            </el-button>
            <!--审核驳回dialog-->
            <el-dialog
              title="提示"
  ...
  export default {
    ...
    filters: {
      ...
      publicNumTypeState(value) {
        return value === 1 ? '合作机构公众号' : value === 2 ? '商户自有公众号' : value === 3 ? '其他商户公众号' : '---'
      },
...
//        this.queryMybankState()
    ...
    methods: {
      ...
      async search(customerid) {
        ...
        let data = await customerDetails(params);
        this.infor = data.result;
        this.imgs = [...this.infor.images];
        this.autidId = data.result.autidId;
        this.phone = data.result.phone;
        this.supportT0 = data.result.supportT0;
        this.clearmode = data.result.clearmode === 2 ? 1 : 0;
        console.log('11111111111:' + data.result.clearmode)
        this.publicNumType = data.result.publicNumType
//        this.tradetypes = data.result.tradetypes
        data.result.tradetypes ? this.tradetypes = data.result.tradetypes.split(',') : this.tradetypes = []
        this.tradetypesStr = this.payTypeToString(this.tradetypes)
        data.result.deniedpays ? this.deniedpays = data.result.deniedpays.split(',') : this.deniedpays = []
//        this.deniedpays = data.result.deniedpays.split(',')
